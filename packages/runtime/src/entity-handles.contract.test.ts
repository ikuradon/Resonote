...
import { createAuftaktRuntimeCoordinator, type EntityHandleState } from '@auftakt/runtime';
...
function createCoordinatorFixture(
  ...
  const coordinator = createAuftaktRuntimeCoordinator({
    entityHandleRuntime: {
      read,
      isDeleted: options.isDeleted,
      openStore: async () => ({
        getRelayHints: async () => options.relayHints ?? []
      }),
...
describe('@auftakt/runtime entity handles', () => {
