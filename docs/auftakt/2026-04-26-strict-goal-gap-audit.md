...
| -------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------- |
| rx-nostr-like reconnect and REQ optimization | `Scoped-Satisfied` | `packages/core/src/relay-session.ts`, `packages/core/src/request-planning.ts`, and core contract tests prove reconnect replay, request coalescing, shard planning, and queueing. Ordinary read gateway proof now covers negentropy-first verification with REQ fallback.                    | Adaptive reconnect/read policy beyond the current coordinator gateway behavior is broader than the scoped target and remains guarded as future transport policy work.                                                                                        | Keep transport behavior and ordinary read gateway regression gates active.         |
...
7. Coordinator-mediated local store facade. `Implemented in this slice; keep local store API regression gates active.`
